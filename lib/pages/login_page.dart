      ...
      child: Column(
        ...
        children: [
          ...
          child: ElevatedButton(  
            onPressed: () {},
            style: ButtonStyle(  
              backgroundColor: MaterialStateProperty.all(const Color.fromARGB(223, 42, 219, 219)),
            ),
            child: const Text(
              'Login',
              style: TextStyle(
        ...
        SizedBox(
          ...
          child: ElevatedButton(  
            onPressed: () {},
            style: ButtonStyle(  
              backgroundColor: MaterialStateProperty.all(const Color.fromARGB(223, 21, 96, 236)),
            ),
            child: const Text(
              'Sign-in with Google',
              style: TextStyle(
